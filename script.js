...
const translations = {
  en: {
    ...
    mainThirdParagraph:
      "Outside of computers, I go hiking, build LEGO, and read manga. Places like the coast and the Columbia River Gorge make me proud to call Oregon home. My LEGO collection is mostly Star Wars, with my favorite set being the UCS Jango Fett's Slave I. One day, I hope to add Rivendell to the collection. My current top 3 manga are One Piece, Slam Dunk, and Mobile Suit Gundam: The Origin (in no particular order). If you've made it this far, thanks for reading.",
  ...
  ko: {
    ...
    mainThirdParagraph:
      "컴퓨터 말고는 등산을 하고, 레고를 조립하고, 만화를 읽습니다. 오리건 해안이나 컬럼비아강 협곡 같은 곳들 덕분에 오리건을 고향이라고 부르는 것이 자랑스럽습니다. 제 레고 컬렉션은 대부분 스타워즈이고, 가장 좋아하는 세트는 UCS 장고 펫의 슬레이브 I입니다. 언젠가는 리븐델도 컬렉션에 더하고 싶습니다. 요즘 제가 가장 좋아하는 만화 3작품은 원피스, 슬램덩크, 그리고 기동전사 건담 디 오리진입니다(순서는 상관없습니다). 여기까지 읽어주셨다면, 정말 감사합니다.",
    footerCreditsFirstPart: "",
    footerCreditsSecondPart: "님의 원작을 바탕으로 제작한 원숭이 스프라이트",
  },
};
